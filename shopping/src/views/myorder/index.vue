...
<script>
import { getaddressList, checkOrder, submitOrder } from "@/api/order";
export default {
  computed: {
    selectAddress() {
    ...
    getObj() {
      (this.goodsId = this.$route.query.goodsId),
        (this.goods_sku_id = this.$route.query.goodsSkuId);
      this.goodsNum = this.$route.query.goodsNum;
      console.log(this.goodsId, this.goods_sku_id, this.goodsNum);
    },
